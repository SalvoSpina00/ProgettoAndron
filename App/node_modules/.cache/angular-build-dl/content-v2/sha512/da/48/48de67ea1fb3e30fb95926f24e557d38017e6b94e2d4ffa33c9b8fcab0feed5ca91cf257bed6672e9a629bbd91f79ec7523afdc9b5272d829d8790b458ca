  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
    ...
    function bP1B(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, formBuilder, request, utilities) {
          ...
          value: function submit() {
            ...
            this.request.post({
              ...
              handler: function handler(response) {
                _this.authService.login(response["access_token"]);
              ...
              error: function error(_error) {
                if (_error.status != 401) {
                  ...
                  var msg = _error.error.info == -1 ? "Il tuo account non è stato ancora attivato!" : "Nome utente o password errati.";
                  _this.errore = msg;
                }
              },
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], src_app_services_request_service__WEBPACK_IMPORTED_MODULE_6__["RequestService"], src_app_services_utilities_service__WEBPACK_IMPORTED_MODULE_7__["UtilitiesService"]])], LoginPage);
      /***/
    }
  }]);
})();
