...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NuovoProdottoPageRoutingModule", function() { return NuovoProdottoPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _nuovo_prodotto_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nuovo-prodotto.page */ "oSnm");
...
let NuovoProdottoPageRoutingModule = class NuovoProdottoPageRoutingModule {
};
NuovoProdottoPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NuovoProdottoPageModule", function() { return NuovoProdottoPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
/* harmony import */ var _nuovo_prodotto_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./nuovo-prodotto-routing.module */ "01VR");
/* harmony import */ var _nuovo_prodotto_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./nuovo-prodotto.page */ "oSnm");
...
let NuovoProdottoPageModule = class NuovoProdottoPageModule {
};
NuovoProdottoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _nuovo_prodotto_routing_module__WEBPACK_IMPORTED_MODULE_5__["NuovoProdottoPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NuovoProdottoPage", function() { return NuovoProdottoPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_nuovo_prodotto_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./nuovo-prodotto.page.html */ "Biks");
/* harmony import */ var _nuovo_prodotto_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nuovo-prodotto.page.scss */ "I6Tu");
...
/* harmony import */ var src_app_services_plugin_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/plugin.service */ "ESzt");
...
let NuovoProdottoPage = class NuovoProdottoPage {
    constructor(navCtrl, request, utilities, plugin, formBuilder) {
        ...
        this.newProductForm = this.formBuilder.group({
            ...
            marca: ['', [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(this.varLength.marca.max),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(this.varLength.marca.min),
                    this.utilities.validatorNotEmpty // required
                ]
            ],
            descrizione: ['', [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(this.varLength.descrizione.max),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(this.varLength.descrizione.min),
                    this.utilities.validatorNotEmpty // required
                ]
            ],
            categoria: ['', [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(this.varLength.categoria.max),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(this.varLength.categoria.min),
                    this.utilities.validatorNotEmpty // required
                ]
            ],
            prezzo: ['', [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].max(this.varLength.prezzo.max),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].min(this.varLength.prezzo.min),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].pattern("^[0-9]*$"),
                ]
            ],
            quantita: ['', [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].max(this.varLength.quantita.max),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].min(this.varLength.quantita.min),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].pattern("^[0-9]*$"),
                ]
            ]
        });
...
NuovoProdottoPage.ctorParameters = () => [
...
NuovoProdottoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=pages-nuovo-prodotto-nuovo-prodotto-module-es2015.js.map