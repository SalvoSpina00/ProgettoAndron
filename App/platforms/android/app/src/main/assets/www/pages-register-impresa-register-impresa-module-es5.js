(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-register-impresa-register-impresa-module"], {
    ...
    /***/
    function HXiJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RegisterImpresaPageModule", function () {
        return RegisterImpresaPageModule;
      });
      /* harmony import */
      ...
      var _register_impresa_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./register-impresa-routing.module */
      "RZb6");
      /* harmony import */


      var _register_impresa_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./register-impresa.page */
      "l/nR");

      var RegisterImpresaPageModule = function RegisterImpresaPageModule() {
        _classCallCheck(this, RegisterImpresaPageModule);
      };

      RegisterImpresaPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _register_impresa_routing_module__WEBPACK_IMPORTED_MODULE_5__["RegisterImpresaPageRoutingModule"]],
    ...
    /***/
    function RZb6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RegisterImpresaPageRoutingModule", function () {
        return RegisterImpresaPageRoutingModule;
      });
      /* harmony import */
      ...
      var _register_impresa_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./register-impresa.page */
      "l/nR");
      ...
      var RegisterImpresaPageRoutingModule = function RegisterImpresaPageRoutingModule() {
        _classCallCheck(this, RegisterImpresaPageRoutingModule);
      };

      RegisterImpresaPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    function lNR(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "RegisterImpresaPage", function () {
        return RegisterImpresaPage;
      });
      /* harmony import */
      ...
      var _raw_loader_register_impresa_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./register-impresa.page.html */
      "7tFP");
      /* harmony import */


      var _register_impresa_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./register-impresa.page.scss */
      "qVmL");
      /* harmony import */
      ...
      var RegisterImpresaPage = /*#__PURE__*/function () {
        function RegisterImpresaPage(navCtrl, plugin, request, utilities, formBuilder) {
          _classCallCheck(this, RegisterImpresaPage);
          ...
          this.errorMessages = {
            ...
            tipo: [{
              ...
              type: "maxlength",
              message: this.defaultMessages.maxlength(this.varLength.tipo.max)
            }, {
              type: "minlength",
              message: this.defaultMessages.minlength(this.varLength.tipo.min)
            }],
            piva: [{
              type: "required",
              message: this.defaultMessages.required
              ...
              type: "pattern",
              message: "Il formato della partita iva non è corretto"
            }],
            cf: [{
              type: "required",
              message: this.defaultMessages.required
          ...
          this.registerImpresaForm = this.formBuilder.group({
            ...
            tipo: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(this.varLength.tipo.max), _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(this.varLength.tipo.min), this.utilities.validatorNotEmpty // required
            ]],
            piva: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].pattern("^[0-9]{11}$")]],
        ...
        _createClass(RegisterImpresaPage, [{
          key: "username",
          get: function get() {
      ...
      RegisterImpresaPage.ctorParameters = function () {
        return [{
      ...
      RegisterImpresaPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], src_app_services_plugin_service__WEBPACK_IMPORTED_MODULE_5__["PluginService"], src_app_services_request_service__WEBPACK_IMPORTED_MODULE_6__["RequestService"], src_app_services_utilities_service__WEBPACK_IMPORTED_MODULE_7__["UtilitiesService"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormBuilder"]])], RegisterImpresaPage);
      /***/
    },
    ...
    /***/
    function qVmL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-register-impresa-register-impresa-module-es5.js.map