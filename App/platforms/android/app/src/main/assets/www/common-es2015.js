...
/* harmony import */ var _ionic_native_image_picker_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/image-picker/ngx */ "tAfe");
...
/* harmony import */ var _utilities_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utilities.service */ "tNc6");
...
let PluginService = class PluginService {
    constructor(geolocation, platform, actionSheetController, imagePicker, camera, utilities) {
    ...
    getCurrentPosition(handler) {
        this.geolocation.getCurrentPosition().then(handler, (error) => {
            this.utilities.alertError({
                header: "Attenzione",
...
PluginService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_6__["Geolocation"],
