  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
    ...
    function hsj(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(storage, request, utilities) {
          var _this = this;
          ...
          this.storage.get("utenza").then(function (a) {
            _this.utenza = a;

            if (_this.utenza == "utente" || _this.utenza == "ente") {
              _this.getSaldo();
            } else {
              _this.searchOrdini();
            }
        ...
        _createClass(HomePage, [{
          ...
          value: function getSaldo() {
            ...
            this.request.get({
              ...
              handler: function handler(response) {
                _this2.budget = response["_msg"].andron;
                _this2.today = new Date().toLocaleDateString();
              },
          ...
          key: "searchOrdini",
          value: function searchOrdini() {
            var _this4 = this;

            this.request.get({
              path: "/orders",
              handler: function handler(response) {
                _this4.ordini = response["_msg"];
              },
              error: function error() {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"], src_app_services_request_service__WEBPACK_IMPORTED_MODULE_5__["RequestService"], src_app_services_utilities_service__WEBPACK_IMPORTED_MODULE_6__["UtilitiesService"]])], HomePage);
      /***/
    }
  }]);
})();
